...
usg(void)
{
    fprintf(stderr, "%s [-x] [-y] [-z] -b bead.off -r reference.off > C.off\n", me);
    exit(2);
}

static int tri(int, He *, const real *, const real *, const real *, /**/ real[3]);
...
static int
tri(int t, He * he, const real *x, const real *y, const real *z, /**/ real r[3])
{
    int i;
    int j;
    int k;
