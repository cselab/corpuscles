...
set key spacing 1.5
plot [0.3:1][1:3.5]\
'../../juelicher/prolate/eng_vol/prolate_final.dat' u 2:($3/Es/$1) w lp pt 1 t 'K_b=0.01 init. config. V_r: prolate', \
'../../juelicher/oblate/eng_vol/oblate_final.dat' u 2:($3/Es/$1) w lp pt 2 t 'K_b=0.01 init. config. V_r: oblate',\
'../../juelicher/sphere/eng_vol/sphere_final.dat' u 2:($3/Es/$1) w lp pt 3 t 'K_b=0.01 init. config.: sphere',\
