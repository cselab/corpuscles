...
#set output "final_eb_vr_gompper_compare.eps"
...
set key spacing 1.5
plot [0.5:0.7][1:2.5]\
'../../gompper_kroll/prolate/eng_vol/prolate_final.dat' u 1:($2/Es1) w lp pt 4 t 'init. config. V_r: prolate', \
'../../gompper_kroll/oblate/eng_vol/oblate_final.dat' u 1:($2/Es1) w lp pt 6 t 'init. config. V_r: oblate',\
'../../gompper_kroll/sphere/eng_vol/sphere_final.dat' u 1:($2/Es1) w lp pt 8 t 'init. config.: sphere',\
