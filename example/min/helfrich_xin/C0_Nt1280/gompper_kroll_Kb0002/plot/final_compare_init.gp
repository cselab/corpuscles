...
set output "final_eb_vr_gompper_init.eps"
...
plot \
'../stomato_Vr0.45_juelicher/stomato_final.dat' u 2:($3/Es/$1) w p lc 6 pt 11 ps psize t 'init. config.: stomato 1',\
'../stomato_Vr0.45/stomato_final.dat' u 2:($3/Es/$1) w p lc 7 pt 13 ps psize t 'init. config.: stomato 2'
