...
set output "final_eb_vr_gompper_Nt.eps"
...
plot \
'../../../C0_Nt1280/gompper_kroll_Kb0002/prolate/eng_vol/prolate_final.dat' u 2:($3/Es/$1) w lp pt 4 ps psize t 'N_t=1280 init. config.: prolate', \
'../../../C0_Nt1280/gompper_kroll_Kb0002/oblate/eng_vol/oblate_final.dat' u 2:($3/Es/$1) w lp pt 6 ps psize t 'N_t=1280 init. config.: oblate', \
'../../../C0_Nt1280/gompper_kroll_Kb0002/sphere/eng_vol/sphere_final.dat' u 2:($3/Es/$1) w lp pt 8 ps psize t 'N_t=1280 init. config.: sphere', \
