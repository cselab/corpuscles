...
if [ $yes -eq 1 ]; then
    ...
    file_out="ref"
    WX=$wx2 WY=$wy1 co.geomview  -r 90 0 0 -f $fos -a ~/app/app1a -p "co.xcolor -a $ref $sa $sb" -o ${file_out}_s.ppm $file_in
...
if [ $yes -eq 1 ]; then
    ...
    file_out="rest"
    WX=$wx2 WY=$wy1 co.geomview  -r 90 0 0 -f $fos -a ~/app/app2a -p "co.xcolor -a $ref $sa $sb" -o ${file_out}_s.ppm $file_in
    WX=$wx2 WY=$wy2 co.geomview  -r 0 0 0 -f $fot -a ~/app/app1a -p "co.xcolor -a $ref $sa $sb" -o ${file_out}_t.ppm $file_in
    convert ${file_out}_s.ppm ${file_out}_s.png
    convert ${file_out}_t.ppm ${file_out}_t.png
    rm ${file_out}_s.ppm
...
if [ $yes -eq 1 ]; then
    ...
    file_out="tt1b_n20"
    WX=$wx2 WY=$wy1 co.geomview  -r 90 0 0 -f $fos -a ~/app/app1a -p "co.xcolor -a $ref $sa $sb" -o ${file_out}_s.ppm $file_in
    WX=$wx2 WY=$wy1 co.geomview  -r 0 0 0 -f $fot -a ~/app/app2a -p "co.xcolor -a $ref $sa $sb" -o ${file_out}_t.ppm $file_in
    WX=$wx2 WY=$wy2 co.geomview  -r 90 90 0 -f $fof -a ~/app/app2a -p "co.xcolor -a $ref $sa $sb" -o ${file_out}_f.ppm $file_in
    convert ${file_out}_s.ppm ${file_out}_s.png
    convert ${file_out}_t.ppm ${file_out}_t.png
    convert ${file_out}_f.ppm ${file_out}_f.png
    rm ${file_out}_s.ppm
    rm ${file_out}_t.ppm
    rm ${file_out}_f.ppm
fi
