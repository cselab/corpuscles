 ...
 * by Shen Hao, 2001.
 * see article
 *   Hao Shen, Pheng Ann Heng and Zesheng Tang.
 *   "A Fast Triangle-Triangle Overlap Test Using Signed Distances"
 *   Journal of Graphics Tools, 8(1):3-15, 2003
 *
