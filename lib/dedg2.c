...
int
dedg2_alpha(const real a[2], const real b[2], const real u[2], const real v[2], real du[2], real dv[2])
{
	real A, s;
...
int
dedg2_strain(real Ka, real a3, real a4, const real a[2], const real b[2], const real u[2], const real v[2], real du[2], real dv[2])
{
	real l, s;
