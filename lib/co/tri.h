...
int tri_vect(const real[3], const real[3], const real[3], const real[3], const real[3], const real[3], FILE*);
int tri_list(const real[3], const real[3], const real[3], const real[3], const real[3], const real[3], FILE*);
