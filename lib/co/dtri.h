...
int dtri_beta(const real[3], const real[3], const real[3], const real u[3], const real v[3], const real w[3], /**/ real[3], real[3], real[3]);
int dtri_lim_area(real Ka, real a3, real a4, const real[3], const real[3], const real[3], const real[3], const real[3], const real[3], /**/ real[3], real[3], real[3]);
int dtri_lim_shear(real mu, real b1, real b2, const real[3], const real[3], const real[3], const real[3], const real[3], const real[3], /**/ real[3], real[3], real[3]);
int dtri_lim(real Ka, real a3, real a4, real mu, real b1, real b2, const real[3], const real[3], const real[3], const real[3], const real[3], const real[3], /**/ real[3], real[3], real[3]);
