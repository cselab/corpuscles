...
int array_copy3(int, const real[], const real[], const real[], real[], real[], real[]);
...
real array_diff3(int, const real[], const real[], const real[], const real[], const real[], const real[]);
real array_diff(int, const real[], const real[]);
real array_dot(int, const real[], const real[]);
real array_l2_3d(int, const real[], const real[], const real[], const real[], const real[], const real[]);
