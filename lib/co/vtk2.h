...
int vtk2_fwrite2(T*, const real*, const real*, const char*, const char*, FILE*);
int vtk2_fwrite3(T*, const real*, const real*, const real*, const char*, const char*, const char*, FILE*);
#undef T