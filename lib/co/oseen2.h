...
int oseen2_velocity(T*, Skel*, real mu, const real*, const real*, const real *fx, const real *fy, const real r[2], real[2]);
int oseen2_stresslet(T*q, Skel*, const real *x, const real *y, real *oxx, real *oxy, real *oyy)
#undef T
