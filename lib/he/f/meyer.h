...
int he_f_meyer_argv(const char***, He*, T**);
int he_f_meyer_fin(T*);
int he_f_meyer_force(T*, He*, const real*, const real*, const real*, /**/ real*, real*, real*);
real he_f_meyer_energy(T*, He*, const real*, const real*, const real*);
