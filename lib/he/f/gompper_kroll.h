...
int he_f_gompper_kroll_argv(const char***, He*, T**);
int he_f_gompper_kroll_fin(T*);
int he_f_gompper_kroll_force(T*, He*, const real*, const real*, const real*, /**/ real*, real*, real*);
real he_f_gompper_kroll_energy(T*, He*, const real*, const real*, const real*);
