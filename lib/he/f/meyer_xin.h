...
int he_f_meyer_xin_force(T*, He*, const real *x, const real *y, const real *z, /**/ real *fx, real *fy, real *fz);
real he_f_meyer_xin_energy(T*, He*, const real *x, const real *y, const real *z);
