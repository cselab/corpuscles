...
int he_f_gompper_xin_argv(const char***, He*, T**);
int he_f_gompper_xin_fin(T*);
int he_f_gompper_xin_force(T*, He*, const real*, const real*, const real*, /**/ real*, real*, real*);
real he_f_gompper_xin_energy(T*, He*, const real*, const real*, const real*);
