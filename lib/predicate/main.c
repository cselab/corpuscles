...
int
grow_expansion(elen, e, b, h)   /* e and h can be the same. */
int elen;
REAL *e;
REAL b;
REAL *h;
...
int
grow_expansion_zeroelim(elen, e, b, h)  /* e and h can be the same. */
int elen;
REAL *e;
REAL b;
REAL *h;
...
int
fast_expansion_sum(elen, e, flen, f, h) /* h cannot be e or f. */
int elen;
REAL *e;
int flen;
REAL *f;
...
int
linear_expansion_sum(elen, e, flen, f, h)   /* h cannot be e or f. */
int elen;
REAL *e;
int flen;
REAL *f;
...
int
linear_expansion_sum_zeroelim(elen, e, flen, f, h)  /* h cannot be e or f. */
int elen;
REAL *e;
int flen;
REAL *f;
...
int
scale_expansion(elen, e, b, h)  /* e and h cannot be the same. */
int elen;
REAL *e;
REAL b;
REAL *h;
...
int
compress(elen, e, h)            /* e and h may be the same. */
int elen;
REAL *e;
REAL *h;
{
...
REAL *pd;
{
    ...
    alen =
        fast_expansion_sum_zeroelim(temp32len, temp32, temp32tlen, temp32t,
                                    adet);
...
REAL permanent;
{
    ...
    if (adxtail != 0.0) {
        if (bdytail != 0.0) {
            ...
            Two_One_Product(adxt_bdyt1, adxt_bdyt0, cdz, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
            ...
            finother = finswap;
            if (cdztail != 0.0) {
                Two_One_Product(adxt_bdyt1, adxt_bdyt0, cdztail, u3, u[2],
                                u[1], u[0]);
                u[3] = u3;
                finlength =
                    fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
        ...
        if (cdytail != 0.0) {
            ...
            Two_One_Product(adxt_cdyt1, adxt_cdyt0, bdz, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
            ...
            finother = finswap;
            if (bdztail != 0.0) {
                Two_One_Product(adxt_cdyt1, adxt_cdyt0, bdztail, u3, u[2],
                                u[1], u[0]);
                u[3] = u3;
                finlength =
                    fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
    ...
    if (bdxtail != 0.0) {
        if (cdytail != 0.0) {
            ...
            Two_One_Product(bdxt_cdyt1, bdxt_cdyt0, adz, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
            ...
            finother = finswap;
            if (adztail != 0.0) {
                Two_One_Product(bdxt_cdyt1, bdxt_cdyt0, adztail, u3, u[2],
                                u[1], u[0]);
                u[3] = u3;
                finlength =
                    fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
        ...
        if (adytail != 0.0) {
            ...
            Two_One_Product(bdxt_adyt1, bdxt_adyt0, cdz, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
            ...
            finother = finswap;
            if (cdztail != 0.0) {
                Two_One_Product(bdxt_adyt1, bdxt_adyt0, cdztail, u3, u[2],
                                u[1], u[0]);
                u[3] = u3;
                finlength =
                    fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
    ...
    if (cdxtail != 0.0) {
        if (adytail != 0.0) {
            ...
            Two_One_Product(cdxt_adyt1, cdxt_adyt0, bdz, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
            ...
            finother = finswap;
            if (bdztail != 0.0) {
                Two_One_Product(cdxt_adyt1, cdxt_adyt0, bdztail, u3, u[2],
                                u[1], u[0]);
                u[3] = u3;
                finlength =
                    fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
        ...
        if (bdytail != 0.0) {
            ...
            Two_One_Product(cdxt_bdyt1, cdxt_bdyt0, adz, u3, u[2], u[1],
                            u[0]);
            u[3] = u3;
            finlength =
                fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
            ...
            finother = finswap;
            if (adztail != 0.0) {
                Two_One_Product(cdxt_bdyt1, cdxt_bdyt0, adztail, u3, u[2],
                                u[1], u[0]);
                u[3] = u3;
                finlength =
                    fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
...
REAL permanent;
{
    ...
    alen =
        fast_expansion_sum_zeroelim(axxbclen, axxbc, ayybclen, ayybc,
                                    adet);
    ...
    blen =
        fast_expansion_sum_zeroelim(bxxcalen, bxxca, byycalen, byyca,
                                    bdet);
    ...
    clen =
        fast_expansion_sum_zeroelim(cxxablen, cxxab, cyyablen, cyyab,
                                    cdet);
    ...
    det += ((adx * adx + ady * ady) * ((bdx * cdytail + cdy * bdxtail)
                                       - (bdy * cdxtail + cdx * bdytail))
            + 2.0 * (adx * adxtail + ady * adytail) * (bdx * cdy -
                                                       bdy * cdx))
        + ((bdx * bdx + bdy * bdy) * ((cdx * adytail + ady * cdxtail)
                                      - (cdy * adxtail + adx * cdytail))
           + 2.0 * (bdx * bdxtail + bdy * bdytail) * (cdx * ady -
                                                      cdy * adx))
        + ((cdx * cdx + cdy * cdy) * ((adx * bdytail + bdy * adxtail)
                                      - (ady * bdxtail + bdx * adytail))
           + 2.0 * (cdx * cdxtail + cdy * cdytail) * (adx * bdy -
                                                      ady * bdx));
    if ((det >= errbound) || (-det >= errbound)) {
        return det;
    }
    ...
    if (adxtail != 0.0) {
        ...
        temp32alen = fast_expansion_sum_zeroelim(temp16alen, temp16a,
                                                 ...
                                                 temp32a);
        temp48len =
            fast_expansion_sum_zeroelim(temp16clen, temp16c, temp32alen,
                                        temp32a, temp48);
        finlength =
    ...
    if ((adxtail != 0.0) || (adytail != 0.0)) {
        if ((bdxtail != 0.0) || (bdytail != 0.0)
            ...
            Two_Two_Diff(ti1, ti0, tj1, tj0, bctt3, bctt[2], bctt[1],
                         bctt[0]);
            bctt[3] = bctt3;
            bcttlen = 4;
        } else {
        ...
        if (adxtail != 0.0) {
            ...
            temp32alen =
                scale_expansion_zeroelim(axtbctlen, axtbct, 2.0 * adx,
                                         temp32a);
            temp48len =
                fast_expansion_sum_zeroelim(temp16alen, temp16a,
            ...
            if (cdytail != 0.0) {
                temp8len =
                    scale_expansion_zeroelim(4, bb, -adxtail, temp8);
                temp16alen =
            ...
            temp64len =
                fast_expansion_sum_zeroelim(temp32alen, temp32a,
        ...
        if (adytail != 0.0) {
            temp16alen =
                scale_expansion_zeroelim(aytbclen, aytbc, adytail,
                                         temp16a);
            aytbctlen =
    ...
    if ((bdxtail != 0.0) || (bdytail != 0.0)) {
        if ((cdxtail != 0.0) || (cdytail != 0.0)
            ...
            Two_Two_Diff(ti1, ti0, tj1, tj0, catt3, catt[2], catt[1],
                         catt[0]);
            catt[3] = catt3;
            cattlen = 4;
        } else {
        ...
        if (bdxtail != 0.0) {
            temp16alen =
                scale_expansion_zeroelim(bxtcalen, bxtca, bdxtail,
                                         temp16a);
            bxtcatlen =
            ...
            if (adytail != 0.0) {
                temp8len =
                    scale_expansion_zeroelim(4, cc, -bdxtail, temp8);
                temp16alen =
        ...
        if (bdytail != 0.0) {
            temp16alen =
                scale_expansion_zeroelim(bytcalen, bytca, bdytail,
                                         temp16a);
            bytcatlen =
    ...
    if ((cdxtail != 0.0) || (cdytail != 0.0)) {
        if ((adxtail != 0.0) || (adytail != 0.0)
            ...
            Two_Two_Diff(ti1, ti0, tj1, tj0, abtt3, abtt[2], abtt[1],
                         abtt[0]);
            abtt[3] = abtt3;
            abttlen = 4;
        } else {
        ...
        if (cdxtail != 0.0) {
            temp16alen =
                scale_expansion_zeroelim(cxtablen, cxtab, cdxtail,
                                         temp16a);
            cxtabtlen =
        ...
        if (cdytail != 0.0) {
            temp16alen =
                scale_expansion_zeroelim(cytablen, cytab, cdytail,
                                         temp16a);
            cytabtlen =
...
REAL *pe;
{
    INEXACT REAL aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez,
        dez;
...
REAL permanent;
{
    ...
    Two_Two_Diff(aexbey1, aexbey0, bexaey1, bexaey0, ab3, ab[2], ab[1],
                 ab[0]);
    ab[3] = ab3;

    Two_Product(bex, cey, bexcey1, bexcey0);
    Two_Product(cex, bey, cexbey1, cexbey0);
    Two_Two_Diff(bexcey1, bexcey0, cexbey1, cexbey0, bc3, bc[2], bc[1],
                 bc[0]);
    bc[3] = bc3;

    Two_Product(cex, dey, cexdey1, cexdey0);
    Two_Product(dex, cey, dexcey1, dexcey0);
    Two_Two_Diff(cexdey1, cexdey0, dexcey1, dexcey0, cd3, cd[2], cd[1],
                 cd[0]);
    cd[3] = cd3;

    Two_Product(dex, aey, dexaey1, dexaey0);
    Two_Product(aex, dey, aexdey1, aexdey0);
    Two_Two_Diff(dexaey1, dexaey0, aexdey1, aexdey0, da3, da[2], da[1],
                 da[0]);
    da[3] = da3;

    Two_Product(aex, cey, aexcey1, aexcey0);
    Two_Product(cex, aey, cexaey1, cexaey0);
    Two_Two_Diff(aexcey1, aexcey0, cexaey1, cexaey0, ac3, ac[2], ac[1],
                 ac[0]);
    ac[3] = ac3;

    Two_Product(bex, dey, bexdey1, bexdey0);
    Two_Product(dex, bey, dexbey1, dexbey0);
    Two_Two_Diff(bexdey1, bexdey0, dexbey1, dexbey0, bd3, bd[2], bd[1],
                 bd[0]);
    bd[3] = bd3;
