...
static int tri_fwrite(He *, const real *, const real *, const real *, const int type[], const char *[], const void *[], /**/ FILE * f);
...
tri_fwrite(He * he, const real * x, const real * y, const real * z,
	   const int type[], const char *names[], const void * scalars[], /**/ FILE * f)
{
    int np, nv, nt, r, i, n_sc, i_sc;
    int a, b, c;
