                    ...
                    const real * z, /**/ real * fx, real * fy, real * fz)
{
    ...
    return he_f_juelicher_xin_force(b->local, he, x, y, z, /**/ fx, fy,
                                    fz);
}
                    ...
                    const real * z, /**/ real * fx, real * fy, real * fz)
{
    ...
    return he_f_garea_voronoi_force(b->local, he, x, y, z, /**/ fx, fy,
                                    fz);
}
                    ...
                    const real * z, /**/ real * fx, real * fy, real * fz)
{
    ...
    return he_f_volume_normal_force(b->local, he, x, y, z, /**/ fx, fy,
                                    fz);
}
