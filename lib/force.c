...
static int garea_sq_force(T *q, He *he, const real *x, const real *y, const real *z,
                               /**/ real *fx, real *fy, real *fz)
{
    Garea_sq *b = CONTAINER_OF(q, Garea_sq, force);
    return he_f_garea_sq_force(b->local, he, x, y, z, /**/ fx, fy, fz);
}
static real garea_sq_energy(T *q, He *he, const real *x, const real *y, const real *z)
{
    Garea_sq *b = CONTAINER_OF(q, Garea_sq, force);
    return he_f_garea_sq_energy(b->local, he, x, y, z);
}
static void* garea_sq_pointer(T *q)
{
    Garea_sq *b = CONTAINER_OF(q, Garea_sq, force);
    return b->local;
}
...
int force_garea_sq_argv(char ***p, He *he, /**/ T **pq)
{
    Garea_sq *q;
    MALLOC(1, &q);
...
static int area_diff_force(T *q, He *he, const real *x, const real *y, const real *z,
                               /**/ real *fx, real *fy, real *fz)
{
    Area_diff *b = CONTAINER_OF(q, Area_diff, force);
    return he_f_area_diff_force(b->local, he, x, y, z, /**/ fx, fy, fz);
}
static real area_diff_energy(T *q, He *he, const real *x, const real *y, const real *z)
{
    Area_diff *b = CONTAINER_OF(q, Area_diff, force);
    return he_f_area_diff_energy(b->local, he, x, y, z);
}
static void* area_diff_pointer(T *q)
{
    Area_diff *b = CONTAINER_OF(q, Area_diff, force);
    return b->local;
}
...
int force_area_diff_argv(char ***p, He *he, /**/ T **pq)
{
    Area_diff *q;
    MALLOC(1, &q);
