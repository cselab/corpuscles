...
struct T
{
	...
	Ode *ode;
	int (*fun)(real, const real*, const real*, const real*, const real*, const real*, const real*, real*, real*, real*, void*);
	void *p;
};
...
int ode3v_apply(T *q, real *time, real t, real *x, real *y, real *z, real *vx, real *vy, real *vz)
{
	int n;
	real *r;
	Ode *ode;
