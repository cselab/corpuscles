...
struct T
{
	...
	Ode *ode;
	int (*fun)(real, const real*, const real*, const real*, const real*, real*, real*, void*);
	void *p;
};
...
ode2v_ini(int type, int n, real dt,
	int (*fun)(real, const real*, const real*, const real*, const real*, real*, real*, void*), void *p, T**pq)
{
	T *q;
	real *r, *x, *y, *vx, *vy, *fx, *fy;
	Ode *ode;
...
int ode2v_apply(T *q, real *time, real t, real *x, real *y, real *vx, real *vy)
{
	int n;
	real *r;
	Ode *ode;
