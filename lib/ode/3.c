...
struct T
{
	...
	Ode *ode;
	int (*fun)(real, const real*, const real*, const real*, real*, real*, real*, void*);
	void *p;
};
...
int
ode3_ini(int type, int n, real dt, int (*fun)(real, const real*, const real*, const real*, real*, real*, real*, void*), void *p, T**pq)
{
	T *q;
	real *r, *x, *y, *z, *fx, *fy, *fz;
	Ode *ode;
