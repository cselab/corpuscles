...
.c.m4.c:; co.m4 -s -o $@ $<
.h.m4.h:; co.m4 -s -o $@ $<
.c.o:;   $(CC)                         -I. $(CFLAGS) $(CO_CFLAGS) `alg.conf --cflags d` -c -o $@ $<
.c.s.o:; $(CC) -I$P/prec/s -Iinc/s -I. $(CFLAGS) $(CO_CFLAGS)  `alg.conf --cflags s` -c -o $@ $<
.c.d.o:; $(CC) -I$P/prec/d -Iinc/d -I. $(CFLAGS) $(CO_CFLAGS) `alg.conf --cflags d`  -c -o $@ $<
.c.l.o:; $(CC) -I$P/prec/l -Iinc/l -I. $(CFLAGS) $(CO_CFLAGS) `alg.conf --cflags l` -c -o $@ $<
