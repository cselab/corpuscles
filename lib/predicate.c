...
real
predicate_orient3d(const real a[3], const real b[3], const real c[3],
                   const real d[3])
{
...
real
predicate_incircle(const real a[2], const real b[2], const real c[2],
                   const real d[2])
{
...
real
predicate_insphere(const real a[3], const real b[3], const real c[3],
                   const real d[3], const real e[3])
{
...
int
predicate_orient3d_sas(const real a[3], const real b[3], const real c[3],
                       const real d[3])
{
...
int
predicate_ray(const real d[3], const real e[3], const real a[3],
...
int
predicate_ray2(const real d[2], const real e[2], const real a[2],
               const real b[2])
{
  int abe, abd, t;
  const real *p;
